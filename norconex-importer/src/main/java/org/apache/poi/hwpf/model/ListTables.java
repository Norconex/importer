...
/*                    !!! IMPORTANT !!!  
 * 
 * This class is a straight copy from Apache POI ScratchPad 3.15:
 * org.apache.poi.hwpf.model.ListTables
 * 
 * It was modified by Norconex to fix a NullPointerException with some Word
 * documents.
 * 
 * This is fixed in upcoming Tika 1.15.
 * 
 * https://github.com/Norconex/importer/issues/41
 * https://issues.apache.org/jira/browse/TIKA-2198
 * https://bz.apache.org/bugzilla/show_bug.cgi?id=60574
 * 
 * Once added in next Tika release, this class should be deleted.
 */
