 ...
 * 
 * It was modified by Norconex to fix wrongful overwriting of detected
 * charset introduced in Tika 1.14.  An issue described here:
 * 
 * https://issues.apache.org/jira/browse/TIKA-2219
 * 
 * Once the issue is fixed in next Tika release, 
