 ...
 * org.apache.tika.parser.external.ExternalParser from Apache Tika 1.7,
 * to fix the output file token never being replaced as it should.
 * Will be gone when fixed by the Apache Tika team.
 */
 ...
 * This class is a copy of the ExternalParser class from Apache Tika 1.7, 
 * modified by Norconex to to fix the output file token never being replaced 
 * as it should.  It will be deleted once fixed by Apache Tika team
