...
/*                    !!! IMPORTANT !!!  
 * 
 * This class is a straight copy from:
 * org.apache.tika.parser.html.HtmlEncodingDetector
 * 
 * It was modified by Norconex to eliminate HTML comments before trying 
 * to extract the charset.  An issue first described here:
 * 
 ...
 * 
 * Once the issue is fixed in Tika, this class should be deleted,
 * along with the META-INF/services/org.apache.tika.detect.EncodingDetector
 * file.
 */
 ...
 */
public class FixedHtmlEncodingDetector implements EncodingDetector {
