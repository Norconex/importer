...
/* XXX === DERIVED =============================================================
 * XXX This source file is derived from the class of the same name found
 * XXX in Apache Tika.  It fixes some bad mime-type associations.
 * XXX This class should be deleted once fixed in Tika.
 * XXX
 * XXX Invalid mappings introduced here:
 * XXX
 * XXX https://github.com/apache/tika/blob/64877c5a6187ecd13e098e99edc97a1f6dc09112/tika-parsers/src/main/java/org/apache/tika/parser/pkg/ZipContainerDetectorBase.java
 * XXX
 * XXX Correct mappings from Microsoft:
 * XXX
 * XXX https://docs.microsoft.com/en-us/previous-versions/office/office-2007-resource-kit/ee309278(v=office.12)
 * XXX
 * XXX Tika JIRA: https://issues.apache.org/jira/browse/TIKA-2922
 * XXX =========================================================================
 */
