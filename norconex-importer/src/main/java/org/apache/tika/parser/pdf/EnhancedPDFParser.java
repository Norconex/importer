...
public class EnhancedPDFParser extends AbstractParser {
    ...
    public void parse(
        ...
        // This flag is always set to avoid the "Please Wait..." sometimes
        // found when extracting files wit XFA content.
        //TODO should be made configurable
        localConfig.setIfXFAExtractOnlyXFA(true);
        
//----- start temp -------------------------------------------------------------------
//localConfig.setExtractInlineImages(true);
//----- end temp -------------------------------------------------------------------
