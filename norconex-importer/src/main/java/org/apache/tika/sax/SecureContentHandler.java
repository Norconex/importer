 ...
 * Derived Work:
 * -------------
 * This class is a copy of the SecureContentHandler class from 
 * Apache Tika 1.11, modified by Norconex to increase the maxDepth limit
 * to 1000 to prevent false Zip bomb detection as described here:
 ...
 * <p>This class is a copy of the SecureContentHandler class from 
 * Apache Tika 1.11, modified by Norconex to increase the maxDepth limit
 * to <code>1000</code> to prevent false Zip bomb detection as described here:
 * <a href="https://github.com/Norconex/collector-http/issues/221">
 * https://github.com/Norconex/collector-http/issues/221</a>.
 * </p>
 * <p>
 * If the fix in this class does not automatically take effect, make sure 
 * this class is loaded first by your classloader (before the original one 
 * from the Tika library). 
 * </p>
 * <p>
 * This class will be removed from Norconex Importer library once/if 
 * the false zip bomb detection is fixed in Tika's original version.
 * </p> 
