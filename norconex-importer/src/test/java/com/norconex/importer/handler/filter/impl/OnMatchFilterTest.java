...
public class OnMatchFilterTest {
    ...
    private void testFilter(IDocumentFilter f, Status expectedStatus) {
        ...
        Assert.assertEquals(expectedStatus, r.getImporterStatus().getStatus());
    }

    private class WithOnMatchFilter implements IDocumentFilter, IOnMatchFilter {
    ...
    private class WithoutOnMatchFilter implements IDocumentFilter {
